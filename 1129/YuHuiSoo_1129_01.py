...
def KMP(word, pattern):
    ...
    for idx in range(len(word)):
        ...
        # 만약 pidx가 패턴의 끝까지 도달하였다면,
        # 시작 인덱스 값을 계산하여 추가 후 pidx 값 table의 인덱스에 접근하여 변경
...
print(KMP("12345678901234567890", "23"))
print(KMP("sunmoonlovehumanlove", "love"))